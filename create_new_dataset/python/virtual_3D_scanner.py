...
def scan_from_trajectory(FOV_h, FOV_v, width, height, dataset_folder, ideal_traj, pcColors_main,
    ...
    if (d_noise_status == "Y" or d_noise_status == "y") and camera_type == "Intel RealSense D415":
        ...
        syst_model1 = readBinFile.read_bin_double(sensor_data_dir + "syst_model.bin")
        syst_model2 = readBinFile.read_bin_double(sensor_data_dir + "syst_model_2.bin")
        syst_model = np.concatenate((syst_model1, syst_model2), axis=0)
